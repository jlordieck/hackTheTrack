...
class StatisticsLogger:
    ...
    def update_instance(self, instance_name: str, key: str, value: Any):
        ...
        """
        data = self.get_instance_data(instance_name)
        data[key] = value

        with open(self._get_instance_file(instance_name), "w") as f:
            yaml.dump(data, f)

    def get_instance_data(self, instance_name: str) -> dict:
        """
